...
- **Changelog-template meteen na de release.** De release zelf zet ook al een lege `internal-docs/RELEASE_<volgende-versie>.md` klaar op `main` (gok bij gebrek aan beter een minor-bump, later te hernoemen indien nodig), zodat de eerste feature-PR van de nieuwe cyclus die template aanvult in plaats van er zelf een op te zetten en de versie te gokken. Zie stap 9 in de [`/release`-skill](.claude/skills/release/SKILL.md).
...
Per alpha/release-bump ligt er een changelog-bestand in `internal-docs/RELEASE_<versie>.md`. Lees de meest recente vóór je werk begint, vooral voor recent gewijzigde features en nieuwe conventies. Huidige: [internal-docs/RELEASE_1.1.0.md](internal-docs/RELEASE_1.1.0.md).
